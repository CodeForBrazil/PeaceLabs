  ...
  <div class="container">
    ...
    @endif 
        <li class="col-sm-4">
          <article class="teaser">
            <header>
              <img class="capa" src="/assets/img/alunuz_capa.png"/>
            <img src="/assets/img/alunuz.jpg" class="profile img-responsive"/>
              <h2>Alunuz</h2>
            </header>
            <div class="teaser-body">
              <p>
        ...
        <li class="col-sm-4">
          <article class="teaser">
            <header>
              <img class="capa" src="/assets/img/peacelabs_capa.png"/>
            <img src="/assets/img/peacelabs.png" class="profile img-responsive"/>
              <h2>Peacelabs</h2>
            </header>
            <div class="teaser-body">
              <p>
        ...
        <li class="col-sm-4">
          <article class="teaser">
            <header>
              <img class="capa" src="/assets/img/ponto_capa.png"/>
            <img src="/assets/img/ponto.jpg" class="profile img-responsive"/>
              <h2>Ponto Acesso</h2>
            </header>
            <div class="teaser-body">
              <p>
